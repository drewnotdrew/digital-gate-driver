...
create_clock -add -name sys_clk_pin -period 78.125 -waveform {0 39.0625} [get_ports { clk }];
...
## Pmod Header JA
# set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { ja[1] }]; #IO_L5N_T0_D07_14 Sch=ja[1]
...
# set_property -dict { PACKAGE_PIN M3    IOSTANDARD LVCMOS33 } [get_ports { pwm_out }]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { pwm_out }]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
...
# set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports { pwm_out }]; #IO_L9P_T1_DQS_34 Sch=pio[44]
# set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { ena }]; #IO_L19P_T3_34 Sch=pio[45]
# set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { d }]; #IO_L13P_T2_MRCC_34 Sch=pio[46]
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { rst }]; #IO_L14P_T2_SRCC_34 Sch=pio[47]
